...
class UserRepository:
    ...
    def create_user(full_name: str, email: str, password: str, role: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(UserRepository.TABLE_NAME).insert(user_data).execute()
    ...
    def get_user_by_id(user_id: int) -> Optional[Dict[str, Any]]:
        """Get user by ID"""
        try:
            response = supabase.table(UserRepository.TABLE_NAME).select("*").eq("id", user_id).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_user_by_email(email: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            email_norm = email.lower().strip()
            response = supabase.table(UserRepository.TABLE_NAME).select("*").eq("email_norm", email_norm).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_user_by_email_role(email: str, role: str, password: str = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            email_norm = email.lower().strip()
            email_role_key = f"{email_norm}_{role}"
            response = supabase.table(UserRepository.TABLE_NAME).select("*").eq("email_role_key", email_role_key).execute()
    ...
    def update_user(user_id: int, update_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            response = supabase.table(UserRepository.TABLE_NAME).update(update_data).eq("id", user_id).execute()
    ...
    def list_users_by_role(role: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(UserRepository.TABLE_NAME).select("*").eq("role", role).execute()
    ...
    def delete_user(user_id: int) -> bool:
        """Delete a user"""
        try:
            response = supabase.table(UserRepository.TABLE_NAME).delete().eq("id", user_id).execute()
            return True
        except Exception as e:
...
class PatientRepository:
    ...
    def create_patient(patient_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(PatientRepository.TABLE_NAME).insert(patient).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_patient_by_id(patient_id: str) -> Optional[Dict[str, Any]]:
        """Get patient by ID"""
        try:
            response = supabase.table(PatientRepository.TABLE_NAME).select("*").eq("id", patient_id).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def search_patients(name: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(PatientRepository.TABLE_NAME).select("*").ilike("name", f"%{name}%").execute()
            return response.data or []
        except Exception as e:
    ...
    def update_patient(patient_id: str, update_data: Dict[str, Any]) -> bool:
        ...
        try:
            update_data['updated_at'] = datetime.utcnow().isoformat()
            response = supabase.table(PatientRepository.TABLE_NAME).update(update_data).eq("id", patient_id).execute()
            return bool(response.data)
        except Exception as e:
    ...
    def update_patient_vitals(patient_id: str, vitals: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = (
                supabase.table(PatientRepository.TABLE_NAME)
    ...
    def get_all_patients(limit: int = 100) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(PatientRepository.TABLE_NAME).select("*").limit(limit).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_patient_names_only(limit: int = 100) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(PatientRepository.TABLE_NAME).select("id, name").limit(limit).execute()
            return response.data or []
        except Exception as e:
...
class DoctorRepository:
    ...
    def create_doctor(doctor_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(DoctorRepository.TABLE_NAME).insert(doctor).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_doctor_by_id(doctor_id: str) -> Optional[Dict[str, Any]]:
        """Get doctor by ID"""
        try:
            response = supabase.table(DoctorRepository.TABLE_NAME).select("*").eq("id", doctor_id).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_doctors_by_specialty(specialty: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(DoctorRepository.TABLE_NAME).select("*").eq("specialty", specialty).execute()
            return response.data or []
        except Exception as e:
    ...
    def search_doctors(name: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(DoctorRepository.TABLE_NAME).select("*").ilike("name", f"%{name}%").execute()
            return response.data or []
        except Exception as e:
    ...
    def update_doctor(doctor_id: str, update_data: Dict[str, Any]) -> bool:
        ...
        try:
            update_data['updated_at'] = datetime.utcnow().isoformat()
            response = supabase.table(DoctorRepository.TABLE_NAME).update(update_data).eq("id", doctor_id).execute()
            return bool(response.data)
        except Exception as e:
    ...
    def get_all_doctors(limit: int = 100) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(DoctorRepository.TABLE_NAME).select("*").limit(limit).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_doctor_names_only(limit: int = 100) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(DoctorRepository.TABLE_NAME).select("id, name, specialty").limit(limit).execute()
            return response.data or []
        except Exception as e:
...
class AppointmentRepository:
    ...
    def create_appointment(appointment_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(AppointmentRepository.TABLE_NAME).insert(appointment).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_appointment_by_id(appointment_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(AppointmentRepository.TABLE_NAME).select("*").eq("id", appointment_id).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_appointments_by_patient(patient_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(AppointmentRepository.TABLE_NAME).select("*").eq("patient_name", patient_name).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_appointments_by_doctor(doctor: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(AppointmentRepository.TABLE_NAME).select("*").eq("doctor", doctor).execute()
            return response.data or []
        except Exception as e:
    ...
    def update_appointment(appointment_id: int, update_data: Dict[str, Any]) -> bool:
        ...
        try:
            update_data['updated_at'] = datetime.utcnow().isoformat()
            response = supabase.table(AppointmentRepository.TABLE_NAME).update(update_data).eq("id", appointment_id).execute()
            return bool(response.data)
        except Exception as e:
    ...
    def delete_appointment(appointment_id: int) -> bool:
        """Delete appointment"""
        try:
            response = supabase.table(AppointmentRepository.TABLE_NAME).delete().eq("id", appointment_id).execute()
            return True
        except Exception as e:
    ...
    def get_all_appointments(limit: int = 20) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(AppointmentRepository.TABLE_NAME).select("*").limit(limit).order("created_at", desc=True).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_confirmed_doctor_for_user(patient_name: str) -> Optional[str]:
        ...
        try:
            response = (
                supabase.table(AppointmentRepository.TABLE_NAME)
                .select("doctor")
...
class MessageRepository:
    ...
    def create_message(message_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(MessageRepository.TABLE_NAME).insert(message).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_all_messages(limit: int = 50) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(MessageRepository.TABLE_NAME).select("*").limit(limit).order("ts", desc=True).execute()
    ...
    def get_messages_since(since_ts: float, limit: int = 100) -> List[Dict[str, Any]]:
        ...
        try:
            response = (
                supabase.table(MessageRepository.TABLE_NAME)
                .select("*")
                .gt("ts", since_ts)
                .limit(limit)
                .order("ts", desc=False)
...
class NotificationRepository:
    ...
    def create_notification(notification_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(NotificationRepository.TABLE_NAME).insert(notification).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_notifications_by_role(role: str, unread_only: bool = False, since_ts: float = 0) -> List[Dict[str, Any]]:
        ...
        try:
            query = supabase.table(NotificationRepository.TABLE_NAME).select("*").eq("role", role)
            if unread_only:
    ...
    def mark_notification_as_read(notification_id: int) -> bool:
        ...
        try:
            response = supabase.table(NotificationRepository.TABLE_NAME).update({"read": True}).eq("id", notification_id).execute()
            return bool(response.data)
        except Exception as e:
...
class ConsultationNoteRepository:
    ...
    def create_note(note_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(ConsultationNoteRepository.TABLE_NAME).insert(note).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_notes_by_patient(patient_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(ConsultationNoteRepository.TABLE_NAME).select("*").eq("patient_name", patient_name).order("ts", desc=True).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_notes_by_doctor(doctor_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(ConsultationNoteRepository.TABLE_NAME).select("*").eq("doctor_name", doctor_name).order("ts", desc=True).limit(50).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_all_notes(limit: int = 50) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(ConsultationNoteRepository.TABLE_NAME).select("*").limit(limit).order("ts", desc=True).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_note_by_id(note_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(ConsultationNoteRepository.TABLE_NAME).select("*").eq("id", note_id).execute()
            return response.data[0] if response.data else None
        except Exception as e:
...
class MedicineLogRepository:
    ...
    def create_log(log_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(MedicineLogRepository.TABLE_NAME).insert(log).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_logs_by_user(user_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(MedicineLogRepository.TABLE_NAME).select("*").eq("taken_by", user_name).order("ts", desc=True).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_all_logs(limit: int = 50) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(MedicineLogRepository.TABLE_NAME).select("*").limit(limit).order("ts", desc=True).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_log_by_id(log_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(MedicineLogRepository.TABLE_NAME).select("*").eq("id", log_id).execute()
            return response.data[0] if response.data else None
        except Exception as e:
...
class SOSAlertRepository:
    ...
    def create_alert(alert_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(SOSAlertRepository.TABLE_NAME).insert(alert).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_recent_alerts(limit: int = 50) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(SOSAlertRepository.TABLE_NAME).select("*").limit(limit).order("ts", desc=True).execute()
            return response.data or []
        except Exception as e:
...
class ReportRepository:
    ...
    def create_report(report_data: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            response = supabase.table(ReportRepository.TABLE_NAME).insert(report).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_report_by_id(report_id: int) -> Optional[Dict[str, Any]]:
        """Get report by ID"""
        try:
            response = supabase.table(ReportRepository.TABLE_NAME).select("*").eq("id", report_id).execute()
            return response.data[0] if response.data else None
        except Exception as e:
    ...
    def get_reports_by_patient(patient_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(ReportRepository.TABLE_NAME).select("*").eq("patient_name", patient_name).order("ts", desc=True).execute()
            return response.data or []
        except Exception as e:
    ...
    def get_reports_by_uploader(uploaded_by: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = (
                supabase.table(ReportRepository.TABLE_NAME)
                .select("*")
    ...
    def update_report(report_id: int, update_data: Dict[str, Any]) -> bool:
        ...
        try:
            update_data['updated_at'] = datetime.utcnow().isoformat()
            response = supabase.table(ReportRepository.TABLE_NAME).update(update_data).eq("id", report_id).execute()
            return bool(response.data)
        except Exception as e:
    ...
    def get_all_reports(limit: int = 50) -> List[Dict[str, Any]]:
        ...
        try:
            response = supabase.table(ReportRepository.TABLE_NAME).select("*").limit(limit).order("ts", desc=True).execute()
            return response.data or []
        except Exception as e:
...
class AuditLogRepository:
    ...
    def create_log(action: str, user_id: int, table_name: str, record_id: str, old_values: Dict = None, new_values: Dict = None) -> bool:
        ...
        try:
            ...
            response = supabase.table(AuditLogRepository.TABLE_NAME).insert(log_data).execute()
            return bool(response.data)
        except Exception as e:
...
class SessionRepository:
    ...
    def create_session(
        ...
        try:
            ...
            response = supabase.table(SessionRepository.TABLE_NAME).insert(row).execute()
    ...
    def get_session(jti: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = (
                supabase.table(SessionRepository.TABLE_NAME)
                .select("*")
                .eq("jti", jti)
                .execute()
            )
